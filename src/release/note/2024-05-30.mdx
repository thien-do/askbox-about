...
**You can now `Cmd K` (or `Ctrl K`) from anywhere to start a new chat 🧼** You no longer need to focus on the ask box first. Even better, the ask box will be focused automatically for you to start a new chat right away.
...
🙇 This is requested by <ReleaseUser name="hai"/>, <ReleaseUser name="Nhi Ly"/>, and <ReleaseUser name="chinh"/>, so thank you!
